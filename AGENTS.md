...
- Click-Cast-Basis (`UI/ClickCast.lua`) mappt Mausbuttons auf Heilzauber, nutzt `/nodbind` zum Setzen/Auflisten und ruft `CastSpellByName` direkt auf dem anvisierten CompactUnitFrame auf.
