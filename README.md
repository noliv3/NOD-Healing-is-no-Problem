...
- GridFrame-Kern (`UI/GridFrame.lua`) erzeugt ein verschiebbares Raster mit Klassenfarben, Tooltip-Hover und Solo-Fallback für Spieler-, Party- und Raid-Mitglieder.
