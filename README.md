...
- GridFrame-Kern (`UI/GridFrame.lua`) erzeugt ein verschiebbares Raster mit Klassenfarben, Tooltip-Hover und Solo-Fallback für Spieler-, Party- und Raid-Mitglieder; der `player`-Frame wird nun immer zuerst aufgebaut und jede Raster-Neuerstellung landet im Feedback-Log (`NODHeal.Feedback.Grid`).
