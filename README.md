...
- Spell-Binding-UI (`UI/BindingFrame.lua`) bietet ein bewegliches Konfigurationsfenster mit Editboxen für Maus- und Modifier-Kombinationen; via `/nodgui` lassen sich Bindings komfortabel pflegen.
